...
public class HaziActivitySimple extends Activity implements View.OnClickListener {
        ...
        switch (v.getId()) {
            ...
            case R.id.btnDownload:
                ...
                if (etUrl.getText().toString().trim().length() > 0) {
                    bmp = ImageDownloader.getBitmapFromURL(etUrl.getText().toString().trim());
            ...
            case R.id.btn_download:
                ...
                if (etUrl.getText().toString().trim().length() > 0) {
                    ...
                    mDownloader = new ImageDownloader(etUrl.getText().toString()
                            .trim(), pb, save, img, percent, HaziActivitySimple.this, bmp, new ImageLoaderListener() {
                        @Override
                        public void onImageDownloaded (Bitmap bmp) {
                            HaziActivitySimple.bmp = bmp;
