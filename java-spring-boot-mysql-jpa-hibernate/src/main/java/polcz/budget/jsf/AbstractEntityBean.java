...
public abstract class AbstractEntityBean<T extends AbstractEntity>
    implements AbstractEntityBeanHelper<T, EntityService>
{
    ...
    protected AbstractEntityBean(Class<?> childClass, Class<T> entityClass)
    {
    ...
    final protected void initBeforeCreate()
    {
    ...
    {
        list = getService().findAll(entityClass);
