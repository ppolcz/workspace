...
public class MarketController extends NameDescController<TMarket> {
    ...
    public String createAlt1(String name, String desc) {
        return super.create(new TMarket(name, desc));
    }
    ...
    public String delete(int uid) {
        return super.delete(new TMarket(), uid);
    }

    @RequestMapping(value = "/update")
    @ResponseBody
    public String update(int id, String name, String desc) {
        return super.update(id, name, desc, TMarket.class);
    }
}