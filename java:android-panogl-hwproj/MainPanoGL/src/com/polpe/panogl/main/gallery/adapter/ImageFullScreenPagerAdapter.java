...
public class ImageFullScreenPagerAdapter extends PagerAdapter {
	...
	// constructor
	public ImageFullScreenPagerAdapter(Activity activity, ArrayList<String> imagePaths) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View viewLayout = inflater.inflate(R.layout.gallery_fullscreen_image, container, false);
