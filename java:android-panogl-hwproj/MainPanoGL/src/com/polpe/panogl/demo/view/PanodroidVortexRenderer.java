...
public class PanodroidVortexRenderer implements GLSurfaceView.Renderer {
    ...
    private final static float backColorRed = 1.0f;
    private final static float backColorGreen = 1.0f;
    ...
    public void onSurfaceCreated (GL10 gl, EGLConfig config) {
        ...
        gl.glClearColor(backColorRed, backColorGreen, backColorBlue, 0.5f);
