...
public class PanodroidGLView extends GLSurfaceView {
    ...
    public PanodroidGLView(Activity activity, CubicPanoNative pano) {
        ...
        // This method can only be called before setRenderer() is called.
        ...
        // This method can only be called after setRenderer() is called.
        ...
        // layer properties: be on top, but do not overlay other views behind it
