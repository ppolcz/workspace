 ...
 *
 * Created on August 30, 2014, 11:07 PM
 */
...
int main (int argc, char *argv[])
{
    ...
    PUpdater updater;
    updater.sl_runCurrentThread();
    
    PTableModel model;

    PTableView table;
    table.setModel(&model);
    controller.setupTableView(&table);

    PInputTranzakcio itran;
    controller.setupInputTranzakcio(&itran);
